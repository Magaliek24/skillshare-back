...
class FileUploadService
{
    ...
    public static function handle_avatar_upload(array $file, $upload_dir = self::UPLOAD_DIR, $max_file_size = self::MAX_FILE_SIZE, $allowed_mime_type = self::ALLOWED_MIME_TYPES): string
    {
        if (
